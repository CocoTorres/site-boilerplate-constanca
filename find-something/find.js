...
function setup() {
    ...
    IMAGE_URL = "../images/processing/" + specie.NAME.toUpperCase() + ".jpg"; 
    // SETA = "seta-02.png";
...
function designPoster() {
    ...
    textAlign(LEFT,TOP);
    textSize(38);
    text(NAME, margin, 35, width - margin*2, height - margin*2);
    
    // Nº DESIGN
    textSize(43);
    textAlign(LEFT, TOP);
    text("N " + NUMBER, margin, 75, width - margin, height - margin*3);
    // RECT
    const image = document.createElement("img");
    image.src = IMAGE_URL;
    image.style.position = "absolute";
    image.style.left = 278 + "px";
